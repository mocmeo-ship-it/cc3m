...
function equi(level) {
  ...
  if (level == 1) var tienthuong = 2000;
  if (level == 2) var tienthuong = 4000;
  if (level == 3) var tienthuong = 6000;
  if (level == 4) var tienthuong = 10000;
  if (level == 5) var tienthuong = 20000;
  if (level == 6) var tienthuong = 30000;
  if (level == 7) var tienthuong = 60000;
  if (level == 8) var tienthuong = 100000;
  if (level == 9) var tienthuong = 140000;
  if (level == 10) var tienthuong = 220000;
  if (level == 11) var tienthuong = 300000;
  if (level == 12) var tienthuong = 400000;
  if (level == 13) var tienthuong = 800000;
  if (level == 14) var tienthuong = 1500000;
  return tienthuong;
}
...
module.exports.handleReply = async function ({ event, Users, api, handleReply, Currencies }) {
  if (handleReply.type == "answer") {
    ...
    if (choose === handleReply.dapandung) {
      ...
      if (level > 5 && level < 10) { var tienthuong = 20000; } else if (level > 10) { var tienthuong = 220000; } else var tienthuong = 0;
      senderInfo.data.altp = { level: -1 };
      await Users.setData(senderID, senderInfo);
      if (tienthuong == 20000) var moc = "đầu tiên";
      if (tienthuong == 220000) var moc = "thứ hai";
